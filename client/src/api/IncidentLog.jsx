...
export const api = {
    ...
    async createLog(log) {
        try {
            const response = await axios.post(`${IP}:${PORT}/`, log);
            return response.data;
        } catch (error) {
    ...
    async getLog(incidentLogId) {
        try {
            const response = await axios.get(`${IP}:${PORT}/${incidentLogId}`);
            return response.data;
        } catch (error) {
    ...
    async updateLog(incidentLogId, updatedLog) {
        try {
            const response = await axios.patch(`${IP}:${PORT}/${incidentLogId}`, updatedLog);
            return response.data;
        } catch (error) {
    ...
    async deleteLog(incidentLogId) {
        try {
            const response = await axios.delete(`${IP}:${PORT}/${incidentLogId}`);
            return response.data;
        } catch (error) {
