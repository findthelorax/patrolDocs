...
// Dispatcher routes
router.route('/mountain/:mountainId/patroller/dispatcher/:date')
    .get(patrollerController.getPatrolDispatcherForDate);
...
router.route ('/mountain/:mountainId/patroller/dispatcher/logs')
    .get(patrollerController.getAllPatrolDispatcherLogs);
