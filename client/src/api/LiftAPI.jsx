...
export const api = {
    ...
    async createLineCheck(mountainId, liftId, lineCheck) {
        try {
            const response = await axios.post(`${IP}:${PORT}/mountain/${mountainId}/lift/${liftId}/linecheck`, lineCheck);
            return response.data;
        } catch (error) {
    ...
    async getLineCheck(mountainId, liftId, lineCheckId) {
        try {
            const response = await axios.get(`${IP}:${PORT}/mountain/${mountainId}/lift/${liftId}/linecheck/${lineCheckId}`);
            return response.data;
        } catch (error) {
    ...
    async updateLineCheck(mountainId, liftId, lineCheckId, updatedLineCheck) {
        try {
            const response = await axios.patch(`${IP}:${PORT}/mountain/${mountainId}/lift/${liftId}/linecheck/${lineCheckId}`, updatedLineCheck);
            return response.data;
        } catch (error) {
    ...
    async deleteLineCheck(mountainId, liftId, lineCheckId) {
        try {
            const response = await axios.delete(`${IP}:${PORT}/mountain/${mountainId}/lift/${liftId}/linecheck/${lineCheckId}`);
            return response.data;
        } catch (error) {
